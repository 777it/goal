...
class MonthDetailViewController: UIViewController, UITextFieldDelegate {
...
//    private let point_color = UIColor(red: 0.145, green: 0.518, blue: 0.157, alpha: 1.0) // 緑
    ...
    override func viewDidLoad() {
        ...
        let giveThings = userDefaults.stringArray(forKey: "KEY_Goal_month_give")
        ...
        let takeThings = userDefaults.stringArray(forKey: "KEY_Goal_month_take")
